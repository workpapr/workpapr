  ...
  for (const scanResult of fresh) {
    ...
    if (prev) {
      ...
      result.push({
        ...
        aiConfidence: scanResult.aiConfidence,
        aiProvenance: scanResult.aiProvenance,
        ai_predicted_disposition: scanResult.ai_predicted_disposition as PersistedFinding["ai_predicted_disposition"],
        ai_predicted_severity: scanResult.ai_predicted_severity,
        ai_reasoning: scanResult.ai_reasoning,
        ai_fp_flag: scanResult.ai_fp_flag,
        ai_fp_reasoning: scanResult.ai_fp_reasoning,
      });
    }
  }
